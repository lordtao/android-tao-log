...
public class Log {
   ...
   public static void v(String message) {
      ...
      android.util.Log.v(Format.getTag(), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void d(String message) {
      ...
      android.util.Log.d(Format.getTag(), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void i(String message) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void w(String message) {
      ...
      android.util.Log.w(Format.getTag(), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void e(String message) {
      ...
      android.util.Log.e(Format.getTag(), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void wtf(String message) {
      ...
      android.util.Log.wtf(Format.getTag(), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void v(String message, Throwable tr) {
      ...
      android.util.Log.v(Format.getTag(), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void d(String message, Throwable tr) {
      ...
      android.util.Log.d(Format.getTag(), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void i(String message, Throwable tr) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void w(String message, Throwable tr) {
      ...
      android.util.Log.w(Format.getTag(), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void e(String message, Throwable tr) {
      ...
      android.util.Log.e(Format.getTag(), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void wtf(String message, Throwable tr) {
      ...
      android.util.Log.wtf(Format.getTag(), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void v(Throwable tr) {
      ...
      android.util.Log.v(Format.getTag(), Format.getFormattedThrowable(tr).toString());
   }
   ...
   public static void d(Throwable tr) {
      ...
      android.util.Log.d(Format.getTag(), Format.getFormattedThrowable(tr).toString());
   }
   ...
   public static void i(Throwable tr) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedThrowable(tr).toString());
   }
   ...
   public static void w(Throwable tr) {
      ...
      android.util.Log.w(Format.getTag(), Format.getFormattedThrowable(tr).toString());
   }
   ...
   public static void e(Throwable tr) {
      ...
      android.util.Log.e(Format.getTag(), Format.getFormattedThrowable(tr).toString());
   }
   ...
   public static void wtf(Throwable tr) {
      ...
      android.util.Log.wtf(Format.getTag(), Format.getFormattedThrowable(tr).toString());
   }
   ...
   public static void v(Object obj, String message) {
      ...
      android.util.Log.v(Format.getTag(obj), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void d(Object obj, String message) {
      ...
      android.util.Log.d(Format.getTag(obj), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void i(Object obj, String message) {
      ...
      android.util.Log.i(Format.getTag(obj), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void w(Object obj, String message) {
      ...
      android.util.Log.w(Format.getTag(obj), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void e(Object obj, String message) {
      ...
      android.util.Log.e(Format.getTag(obj), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void wtf(Object obj, String message) {
      ...
      android.util.Log.wtf(Format.getTag(obj), Format.getFormattedMessage(message).toString());
   }
   ...
   public static void v(Object obj, String message, Throwable tr) {
      ...
      android.util.Log.v(Format.getTag(obj), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void d(Object obj, String message, Throwable tr) {
      ...
      android.util.Log.d(Format.getTag(obj), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void i(Object obj, String message, Throwable tr) {
      ...
      android.util.Log.i(Format.getTag(obj), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void w(Object obj, String message, Throwable tr) {
      ...
      android.util.Log.w(Format.getTag(obj), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void e(Object obj, String message, Throwable tr) {
      ...
      android.util.Log.e(Format.getTag(obj), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void wtf(Object obj, String message, Throwable tr) {
      ...
      android.util.Log.wtf(Format.getTag(obj), Format.getFormattedThrowable(message, tr).toString());
   }
   ...
   public static void map(Map<?, ?> map, String title) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedMessage(Format.map(map), title).toString());
   }
   ...
   public static void list(List<?> list, String title) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedMessage(Format.list(list), title).toString());
   }
   ...
   public static <T> void array(T[] array, String title) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedMessage(Format.array(array), title).toString());
   }
   ...
   public static void objl(Object obj) {
      ...
      android.util.Log.i(Format.getTag(), Format.getFormattedMessage(Format.objl(obj), obj.getClass().getSimpleName()).toString());
   }
   ...
   public static void threadInfo(String message, Throwable throwable) {
      ...
      Format.addMessage(sb, message);
      Format.addStackTrace(sb, throwable);
      android.util.Log.v(Format.getTag(), Format.getFormattedMessage(sb.toString()).toString());
   }
