...
import ua.at.tsvetkov.util.Log.logToAll
...
object LongLog {
    ...
    @JvmStatic
    fun objl(obj: Any) {
        print(getTag(), getFormattedMessage(Format.objl(obj), obj.javaClass.simpleName), Level.INFO, false)
    }
    ...
    @JvmStatic
    fun objn(obj: Any) {
        print(getTag(), getFormattedMessage(Format.objn(obj), obj.javaClass.simpleName), Level.INFO, false)
    }
